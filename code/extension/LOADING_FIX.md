...
```javascript
fetch('https://api.example.com/news/81f71cd2-30dd-4407-93e3-b715ac32490c')
  .then((r) => r.json())
...
```
[sk-mockAPI] Checking URL: https://api.example.com/news/... -> pathname: /news/...
[sk-mockAPI] Route matched: /news/...
[sk-mockAPI] ✅ Intercepting fetch: https://api.example.com/news/...
[sk-mockAPI] ✅ Returning mock response for: https://api.example.com/news/...
